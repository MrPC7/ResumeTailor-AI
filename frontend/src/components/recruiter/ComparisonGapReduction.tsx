    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      >
        <h3 className="flex items-center gap-2 text-sm font-medium text-muted-foreground">
          <span
            className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-red-100 text-red-600 text-xs"
            aria-hidden="true"
          >
            ↓
          </span>
      ...
      >
        <h3 className="flex items-center gap-2 text-sm font-medium text-muted-foreground">
          <span
            className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 text-xs"
            aria-hidden="true"
          >
            ↑
          </span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 h-2 rounded-full bg-muted overflow-hidden">
              <div
                ...
                style={{ width: `${strengthsBefore > 0 ? Math.min(100, strengthsBefore * 20) : 0}%` }}
                role="progressbar"
